  ...
  <div class="sections">
      ...
      <div class="section-box">
        <div class="item" v-for="item in $attrs.coreData.categories" :key="item.id">
          <NuxtLink
            ...
            ">
            <div class="image">
              <img :src="baseUrl + item.image" onerror="this.onerror=null; this.src='assets/project.jpeg';" />
            </div>
    ...
    <div class="section">
      <div class="section-title">
        ...
        <NuxtLink to="/events"><div class="all">all ></div></NuxtLink>
      </div>
      <div class="section-box">
        ...
        <div class="item" v-for="item in $attrs.coreData.ratings" :key="item.id">
          <NuxtLink :to="`/singlePost-${item.id}/${item.name}`">
                ...
                <svg
                  ...
                  <defs>
                    <clipPath id="clip0_352_347">
                      <rect width="18" height="19.4" fill="white" transform="translate(0 0.0102539)" />
                    </clipPath>
                  </defs>
                </svg>
            ...
            <div class="description">
              <span v-if="item.rating <= 5"> {{ item.rating }} / 5 </span> <span v-else> 5 / 5 </span>
            </div>
          </NuxtLink>
        </div>
      </div>
    ...
    <div class="section">
      ...
      <div class="section-box">
        <div class="item" v-for="item in $attrs.coreData.sponsors" :key="item.id">
          ...
          <NuxtLink v-if="item.mainPage == true" :to="item.url">
            <div class="image">
              <img :src="baseUrl + item.icon" onerror="this.onerror=null; this.src='assets/project.jpeg';" />
            </div>
            <div class="description">{{ item.name }}</div>
            <!-- <div class="badge">7 dni</div> -->
          </NuxtLink>
